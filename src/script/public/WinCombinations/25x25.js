...
function diagonale_Linie2_for25(n) {
    for (let i = 0; i <= n; i++) {
        ...
        subArray.push(i + 3, i + 27, i + 51, i + 75);
        WinConditions.push(subArray);

        if (i + 75 + 3 >= (xCell_Amount * yCell_Amount - 1)) {
            break;
        };
    };
};
...
function diagonales_viereck_for25(n) {
    for (let i = 1; i <= n; i++) {
        ...
        if (i + 50 >= (xCell_Amount * yCell_Amount - 2)) {
            break;
        };
    };
};
...
function zweig_unten_for25(n) {
    for (let i = 0; i <= n; i++) {
        ...
        if (i + 76 >= (xCell_Amount * yCell_Amount - 2)) {
            break;
        };
    };
};
...
function zweig_rechts_for25(n) {
    for (let i = 0; i <= n; i++) {
        ...
        if (i + 50 >= (xCell_Amount * yCell_Amount - 4)) {
            break;
        };
    };
};
...
function block_mit_Ast_1_for25(n) {
    for (let i = 0; i <= n; i++) {
        ...
        if (i + 26 >= (xCell_Amount * yCell_Amount - 2)) {
            break;
        };
    };
};
...
function L_2_for25(n) {
    for (let i = 2; i <= n; i++) {
        ...
        subArray.push(i, i + 25, i + 50, i + 49, i + 48);
        WinConditions.push(subArray);
...
function W_3_for25(n) {
    for (let i = 1; i <= n; i++) {
        ...
        if (i + 49 >= (xCell_Amount * yCell_Amount - 3)) {
            break;
        };
    };
};
